...
MCOORD Zn 2 123 154 203 259 			    # Coordinate Zn 2+ to the specified residue numbers.
MCOORD Cu 1 5.42 5.43 M5.46			        # Coordinate Cu+ to specified residues by BW number, only including the third if it is methionine.
```

Coordinate a metal ion to the indicated residues. A minimum of 3 residues is required.

If any metal coordination residue is a CYS or SEC, it will be thiolated (or selenolated), meaning its hydrogen atom will be removed and its
binding chalcogen atom will be ionized to the -1 state.

Tyrosine is treated as an aromatic ring for purposes of metal coordination.
