...
<ul>
  <li>If you have <a href="https://openbabel.org">obabel</a>, you can generate 3 dimensional SDFs from SMILES input. Example syntax:<br>
    `obabel -:'CCO' --gen3D -osdf -Osdf/ethanol.sdf`. There is also a script located at `data/gensdf.sh` that will make the obabel call
    if given a compound name and a SMILES string.
  </li>
